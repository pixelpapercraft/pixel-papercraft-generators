...
import { type Generator, type RegionClickHandler } from "./generator";
import {
...
export function GeneratorRenderer<Props>({
  ...
  // Fresh `Model`/`Engine` per render pass — this is the reactive seam:
  ...
  // `setState`) recomputes the pages directly. No ref is needed to keep
  // `onRegionClick` fresh: `props` is
