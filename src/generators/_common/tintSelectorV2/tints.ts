...
export type TintSwatch = {
  id: string;
  label: string;
  color: string;
};

export type TintSwatchGroup = {
  id: string;
  label: string;
  options: TintSwatch[];
};

function makeTintSwatchGroup(
  id: string,
  label: string,
  options: Array<Omit<TintSwatch, "id">>
): TintSwatchGroup {
  return {
    id,
    label,
...
export const leatherTintGroup = makeTintSwatchGroup("leather", "Leather", [
  { label: "Leather", color: "#A06540" },
]);

export const dyeTintGroup = makeTintSwatchGroup("dye", "Dyes", [
...
export const grassTintGroup = makeTintSwatchGroup("grass", "Grass", [
...
export const foliageTintGroup = makeTintSwatchGroup("foliage", "Foliage", [
...
export const dryFoliageTintGroup = makeTintSwatchGroup(
  "dry-foliage",
  "Dry Foliage",
  [
    { label: "Badlands", color: "#9E814D" },
...
export const waterTintGroup = makeTintSwatchGroup("water", "Water", [
...
export const redstoneTintGroup = makeTintSwatchGroup("redstone", "Redstone", [
...
export const stemTintGroup = makeTintSwatchGroup("stem", "Stem", [
...
export const potionTintGroup = makeTintSwatchGroup("potion", "Potions", [
...
export const blockTintSwatchGroups: TintSwatchGroup[] = [
  grassTintGroup,
  foliageTintGroup,
  dryFoliageTintGroup,
  waterTintGroup,
...
export const itemTintSwatchGroups: TintSwatchGroup[] = [
  dyeTintGroup,
  leatherTintGroup,
  potionTintGroup,
  ...blockTintSwatchGroups,
];

export const armorTintSwatchGroups: TintSwatchGroup[] = [
  leatherTintGroup,
  dyeTintGroup,
];

export const catTintSwatchGroups: TintSwatchGroup[] = [dyeTintGroup];
