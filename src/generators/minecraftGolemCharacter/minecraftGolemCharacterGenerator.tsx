...
// `dynamicTextures`, same as minecraftEndermanCharacter. Selecting "None" then
...
const minecraftGolemCharacterGenerator: Generator<MinecraftGolemCharacterProps> =
    ...
    <div>
      ...
      <div className="lg:flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          <GeneratorRenderer
            generator={minecraftGolemCharacterGenerator}
            props={rendererProps}
