...
// through `dynamicTextures`, same as minecraftCharacter. See the migration
...
const minecraftMutantCharacterGenerator: Generator<MinecraftMutantCharacterProps> =
  {
    id,
    name,
    images,
    ...
    <div>
      ...
      <div className="lg:flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          <GeneratorRenderer
            generator={minecraftMutantCharacterGenerator}
            props={rendererProps}
