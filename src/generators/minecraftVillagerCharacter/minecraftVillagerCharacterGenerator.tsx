...
// `dynamicTextures`, same as minecraftCatCharacter. Selecting "None" then
...
const minecraftVillagerCharacterGenerator: Generator<MinecraftVillagerCharacterProps> =
    ...
    <div>
      ...
      <div className="lg:flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          <GeneratorRenderer
            generator={minecraftVillagerCharacterGenerator}
            props={rendererProps}
