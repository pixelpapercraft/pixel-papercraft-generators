...
import backgroundSprites from "../minecraftPig/images/background-sprites.png";
import foldSprites from "../minecraftPig/images/fold-sprites.png";
import labelSprites from "../minecraftPig/images/label-sprites.png";
import titleSprites from "../minecraftPig/images/title-sprites.png";
import pigVanilla from "../minecraftPig/textures/vanilla/pig2.png";
import pigVanillaProgrammerArt from "../minecraftPig/textures/vanilla/pig.png";
import pigFaithful from "../minecraftPig/textures/faithful/pig.png";
import pigSpacePig from "../minecraftPig/textures/space-pig/pig.png";
import saddleVanilla from "../minecraftPig/textures/vanilla/pig_saddle2.png";
import saddleVanillaProgrammerArt from "../minecraftPig/textures/vanilla/pig_saddle.png";
import saddleFaithful from "../minecraftPig/textures/faithful/saddle.png";
import saddleSpacePig from "../minecraftPig/textures/space-pig/saddle.png";
import diamondArmorVanilla from "../minecraftPig/textures/vanilla/diamond-armor.png";
import goldArmorVanilla from "../minecraftPig/textures/vanilla/gold-armor.png";
import chainmailArmorVanilla from "../minecraftPig/textures/vanilla/chainmail-armor.png";
import ironArmorVanilla from "../minecraftPig/textures/vanilla/iron-armor.png";
import diamondArmorFaithful from "../minecraftPig/textures/faithful/diamond-armor.png";
import goldArmorFaithful from "../minecraftPig/textures/faithful/gold-armor.png";
import chainmailArmorFaithful from "../minecraftPig/textures/faithful/chainmail-armor.png";
import ironArmorFaithful from "../minecraftPig/textures/faithful/iron-armor.png";
...
const render = (ctx: RenderContext, props: MinecraftPigProps): void => {
  // Input names
...
const minecraftPigGeneratorV2: GeneratorV2<MinecraftPigProps> = {
  id,
  name,
  images,
  textures,
...
function Component(): JSX.Element {
  const [pig, setPig] = React.useState<Texture | null>(null);
  ...
  const [noseStyle, setNoseStyle] = React.useState("Flat");
  ...
  const rendererProps: MinecraftPigProps = {
    showFolds,
    showLabels,
    showTitles,
        ...
        <div className="flex-1 min-w-0" data-testid="generator-sidebar">
          <div className="w-full bg-gray-100 p-8 space-y-4">
            ...
            <GeneratorUI.SelectControl
              label="Nose Style"
              options={options(["Flat", "3D"])}
              value={noseStyle}
              onValueChange={setNoseStyle}
            />
            <GeneratorUI.SelectControl
              label="Head Style"
