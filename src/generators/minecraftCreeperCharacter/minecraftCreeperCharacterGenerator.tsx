...
// `dynamicTextures`, same as minecraftCharacter. This is why explicit "None"
...
// texture option exactly (same technique as minecraftCharacterHeads).
const skinOptions = [
  ...makeDefaultMinecraftSkinPresetOptions(),
  makeMinecraftSkinPresetOption(
    "Default (Slim)",
...
const minecraftCreeperCharacterGenerator: Generator<MinecraftCreeperCharacterProps> =
    ...
    <div>
      ...
      <div className="lg:flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          <GeneratorRenderer
            generator={minecraftCreeperCharacterGenerator}
            props={rendererProps}
