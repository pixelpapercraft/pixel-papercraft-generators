...
const render = (ctx: RenderContext, props: MinecraftVillagerProps): void => {
  ...
  if (villagertype) {
    ...
    if (professionButcher) {
      drawing.drawHatOverlay(82, 83, "Butcher");
    ...
    if (professionLibrarian) {
      ...
      drawing.drawMiddleArmOverlay(46, 643, "Librarian");
    }
    if (professionMason) {
  ...
  if (zombietype) {
    ...
    if (professionButcher) {
      drawing.drawHatOverlay(82, 83, "ZombieButcher");
...
const minecraftVillagerGenerator: Generator<MinecraftVillagerProps> = {
  id,
  name,
  images,
  textures,
    ...
    <div>
      ...
      <div className="lg:flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          <GeneratorRenderer
            generator={minecraftVillagerGenerator}
            props={rendererProps}
          />
        </div>
      </div>
