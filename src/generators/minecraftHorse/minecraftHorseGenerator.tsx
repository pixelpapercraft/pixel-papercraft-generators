...
// below (matching minecraftArmor's pattern). Entries whose id matches a
...
// make that explicit, matching the technique minecraftGolemCharacter uses
// for its Flower pass.
...
const minecraftHorseGenerator: Generator<MinecraftHorseProps> = {
  id,
  name,
  images,
    ...
    <div>
      ...
      <div className="lg:flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          <GeneratorRenderer
            generator={minecraftHorseGenerator}
            props={rendererProps}
